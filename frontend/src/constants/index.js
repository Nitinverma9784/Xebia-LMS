export const BRAND_DEFAULTS = {
  ...
  sidebarLogo: '/assets/xebia-logo.svg',
  headerLogo: '/assets/xebia-logo.svg',
  favicon: '/assets/favicon.svg',
  loginBackground: null,
  lightModeLogo: '/assets/xebia-logo.svg',
  darkModeLogo: '/assets/xebia-logo.svg',
  websiteLogo: '/assets/xebia-logo.svg',
  loginLogo: '/assets/xebia-logo.svg',
  mobileLogo: '/assets/xebia-logo.svg',
  footerLogo: '/assets/xebia-logo.svg',
};
