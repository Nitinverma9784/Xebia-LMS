                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {paginatedSubmissions.map((sub) => {
                      ...
                      return (
                        <div
                          key={sub.id}
                          className="bg-white dark:bg-[#1E293B] border border-[var(--brand-border)] rounded-2xl p-5 hover:shadow-md transition-all duration-200 relative group flex flex-col md:flex-row gap-5 justify-between items-start md:items-center"
                        >
                          {/* Student identity details */}
                          <div className="flex items-center gap-4 min-w-0">
                            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#6C1D5F] to-[#01AC9F] flex items-center justify-center text-white text-sm font-black shadow-inner shrink-0">
                              {initials}
                            </div>
                            <div className="min-w-0 space-y-1">
                              ...
                              <div className="flex flex-wrap gap-2 text-[10px] text-[var(--text-secondary)] font-medium">
                                <span>Batch: {sub.student?.batchName || 'General Class'}</span>
                                <span>•</span>
                                <span>Semester: Semester 3</span>
                              </div>
                            </div>
                          </div>

                          {/* Submission Details */}
                          <div className="flex-1 md:px-4 space-y-2.5 w-full">
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                              {/* Submission Type */}
                              <div className="bg-slate-50 dark:bg-slate-800/40 p-2 rounded-xl border border-[var(--brand-border)]">
                              ...
                              {/* Title / Subject */}
                              <div className="bg-slate-50 dark:bg-slate-800/40 p-2 rounded-xl border border-[var(--brand-border)] min-w-0">
                                <span className="text-[9px] uppercase font-bold tracking-wider text-[var(--text-secondary)] block">Title & Subject</span>
                                <span className="text-xs text-[var(--text-primary)] font-medium truncate block" title={selectedAssignment.title}>
                              ...
                              <div className="bg-slate-50 dark:bg-slate-800/40 p-2 rounded-xl border border-[var(--brand-border)]">
                                ...
                                <span className="text-xs font-bold text-[#6C1D5F] dark:text-purple-300">
                          ...
                          <div className="flex flex-row md:flex-col items-center md:items-end justify-between md:justify-center gap-3 shrink-0 w-full md:w-auto pt-3 md:pt-0 border-t md:border-t-0 border-[var(--brand-border)]">
                            ...
                            <div>
                              ...
                              {!isPending && isLate && (
                                <span className="text-[10px] font-bold px-2.5 py-1 rounded-xl bg-rose-100 dark:bg-rose-950/20 text-rose-600 dark:text-rose-400 border border-rose-200 dark:border-rose-900/30 mr-1.5">
                                  Late Submission
                                </span>
                              )}
