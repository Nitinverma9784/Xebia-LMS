...
import { Plus, Search, Eye, Edit, Trash2, HelpCircle } from 'lucide-react';
...
export const TeacherQuizzes: React.FC = () => {
  ...
  const fetchQuizzes = useCallback(async () => {
    ...
    try {
      ...
      const quizList = res.assignments.filter((a) => a.assignmentType === 'QUIZ');
      setQuizzes(quizList);
      setPagination({
        ...res.pagination,
  ...
  return (
    <Layout role="teacher" title="Quizzes" subtitle="Create and manage your online quizzes">
      {/* Top Bar */}
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-5">
        ...
        <div className="flex gap-2 shrink-0 flex-wrap">
          ...
          <Button
            variant="primary"
            icon={<Plus size={16} />}
            onClick={() => navigate('/teacher/assignments/create?type=quiz')}
          >
            New Quiz
          </Button>
        </div>
                ...
                <tr>
                  <td colSpan={8}>
                    <EmptyState
                      ...
                      description="Create your first online quiz to get started."
                      action={{ label: 'Create Quiz', onClick: () => navigate('/teacher/assignments/create?type=quiz') }}
                    />
                  </td>
                </tr>
              ) : (
                  ...
                  <tr key={a.id} className="table-row-hover">
                    ...
                    <td className="px-4 py-3.5">
                      <div className="flex items-center gap-1">
                        ...
                        <Link
                          to={`/teacher/assignments/edit/${a.id}?type=quiz`}
                          title="Edit"
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--text-secondary)] mt-1">
              This will also delete all student quiz attempts. This action cannot be undone.
            </p>
          </div>
        </div>
      </Modal>
