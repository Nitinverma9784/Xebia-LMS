              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                {assignments.map((a) => (
                  ...
                  >
                    ...
                    <span className="inline-flex items-center gap-1.5 text-xs text-[var(--text-secondary)] mb-3">
                      <BookOpen size={12} />
                      {a.subject}
                    </span>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-xs text-[var(--text-secondary)]">Due: {formatDate(a.dueDate)}</p>
